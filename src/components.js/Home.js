    ...
    <div className={`home flex card transition duration-300 bg-gray-300`}>
      ...
      >
        <ul className="ul-container text-gray-200 p-4 m-20 mr-25 bg-gray-800 opacity-75 transition duration-300 rounded-lg">
          ...
          <div
            className={` transition duration-500 home-img-container absolute ${
              mouseOn.colloseum.isHover
                ? "flex flex-col"
                : `${mouseOn.colloseum.selected ? "opacity-1" : "opacity-0"}`
            }`}
          >
          ...
          <li
            className="monument-name m-5 relative"
          ...
          <div
            className={` transition duration-500 home-img-container absolute ${
              mouseOn.fontannaDiTrevi.isHover
                ? "flex flex-col"
                : `${
                    mouseOn.fontannaDiTrevi.selected ? "opacity-1" : "opacity-0"
                  }`
            }`}
          >
            <img
          ...
          <div
            className={`transition duration-500 home-img-container absolute ${
              mouseOn.forumRomanum.isHover
                ? "flex flex-col"
                : `${mouseOn.forumRomanum.selected ? "opacity-1" : "opacity-0"}`
            }`}
          >
            <img
              src={forumRomanum}
          ...
          <div
            className={`transition duration-500 home-img-container absolute ${
              mouseOn.muzeaWatykanskie.isHover
                ? "flex flex-col"
                : `${
                    mouseOn.muzeaWatykanskie.selected
                      ? "opacity-1"
                      : "opacity-0"
                  }`
            }`}
          ...
          <div
            className={`transition duration-500 home-img-container absolute ${
              mouseOn.kaplicaSykstynska.isHover
                ? "flex flex-col"
                : `${
                    mouseOn.kaplicaSykstynska.selected
                      ? "opacity-1"
                      : "opacity-0"
                  }`
            }`}
